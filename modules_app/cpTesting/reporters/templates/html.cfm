...
<div class="buttonBar">
	<a href="#variables.baseURL#" class="inc-tb-file-btn tb-file-btn"><button title="Run all the tests">Run All</button></a>
...
<cfloop array="#variables.bundleStats#" index="thisBundle">
	...
	<div class="box bundle" id="bundleStats_#thisBundle.path#" data-bundle="#thisBundle.path#">
		...
		<h2><a href="#variables.baseURL#/testBundles/#testBundles#" class="inc-tb-file-btn tb-file-btn" title="Run only this bundle">#thisBundle.path#</a> (#thisBundle.totalDuration# ms)</h2>
	...
	<cfsavecontent variable="local.report">
		...
		<li>
			...
			<a title="Total: #arguments.suiteStats.totalSpecs# Passed:#arguments.suiteStats.totalPass# Failed:#arguments.suiteStats.totalFail# Errors:#arguments.suiteStats.totalError# Skipped:#arguments.suiteStats.totalSkipped#"
			   ...
			   class="inc-tb-file-btn tb-file-btn #lcase( arguments.suiteStats.status )#"><strong>+#arguments.suiteStats.name#</strong></a>
			...
			<cfloop array="#arguments.suiteStats.specStats#" index="local.thisSpec">
				...
				<div class="spec #lcase( local.thisSpec.status )#" data-bundleid="#arguments.bundleStats.id#" data-specid="#local.thisSpec.id#">
					<li>
						...
						<cfset testBundles=ReplaceNoCase(arguments.bundleStats.path,'/',':','ALL') />
						<a href="#variables.baseURL#/testSpecs/#testSpecs#/testBundles/#testBundles#" class="inc-tb-file-btn tb-file-btn #lcase( local.thisSpec.status )#">#local.thisSpec.name# (#local.thisSpec.totalDuration# ms)</a>
