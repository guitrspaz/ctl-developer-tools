...
component{
	...
	*/
	any function runReport(
		...
		WriteLog(SerializeJSON({'variables':variables.filter(function(key,value){ return (!isNull(value) && isSimpleValue(value)); })},false,false),'information','yes','HTMLReporterLog');
